...
# Пользователь вводит логин и пароль, после чего происходит поиск записи в БД
# по ним. Если запись есть, то применяется метод add_authorized_users(), где добавляется запись с авторизованными
# пользователями
